 ...
 * @author Allison
 */
public class Test_modif_taxi extends javax.swing.JFrame {

    /**
     * Creates new form Test_modif_taxi
     */
    public Test_modif_taxi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modification d'un taxi");
        ...
        btn_modif.setText("2. Modifier ce taxi");
        btn_modif.setActionCommand("1. Rechercher ce taxi");

        btn_rech_modif.setText("1. Rechercher ce taxi");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btn_modif, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Test_modif_taxi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Test_modif_taxi().setVisible(true);
            }
        });
    }
