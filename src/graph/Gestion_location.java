...
public class Gestion_location extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txt_id_loc.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txt_id_locKeyTyped(evt);
            }
        });
    ...
    private void txt_id_locKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_id_locKeyTyped
        char c = evt.getKeyChar();
        if (Character.isLetter(c) || (Character.isSpaceChar(c))) {
            txt_id_loc.setEditable(false);
        } else {
            txt_id_loc.setEditable(true);
        }
    }//GEN-LAST:event_txt_id_locKeyTyped
